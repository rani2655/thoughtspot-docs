...
To sign out of your ThoughtSpot account, select the user icon at the far right of the top navigation bar. Scroll down to the *Profile* section of your user profile, and select *Sign out*.
