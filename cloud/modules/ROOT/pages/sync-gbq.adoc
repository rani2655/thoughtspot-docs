...
. From the *Choose an existing connection* window, select your data warehouse. If you do not have an existing connection to Google BigQuery, click *Select here* under *Data warehouse* and select *Add new connection*.
+
