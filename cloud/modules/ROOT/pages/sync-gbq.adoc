...
. In the upper-right corner of the Answer, click the *more options* menu icon image:icon-more-10px.png[More options menu icon]. From the dropdown menu, select *Sync to other apps*, then choose *Google BigQuery*.
+
...
. If this is the first sync you have created for Google BigQuery, a pop-up authorization window appears. To give ThoughtSpot permission to send data to your Google BigQuery account, select your account from the pop-up window.
...
* If you have more than one Google BigQuery destination set up, then the *Destination* field appears, and you will have to select a Google BigQuery destination from the dropdown menu available. However, if no destinations have been set up before or if you have only one Google BigQuery destination, the *Destination* field will not appear.
* Select your Google BigQuery *Object* from the dropdown menu.
...
.  If this is the first sync you have created for the selected app, an authorization page appears. To give ThoughtSpot permission to send data to your Google BigQuery account, click *Sign in with Google BigQuery*, select your account, and click *Allow*.

. Fill in the following parameters:

* Edit the *Pipeline name* if needed. By default, this field populates with _PL-[Answer Name]_.
* If you have more than one Google BigQuery destination set up, then the *Destination* field appears and you have to select a Google BigQuery destination from the dropdown menu available. However, if no destinations have been set up before or if you have only one Google BigQuery destination, the *Destination* field will not appear.
