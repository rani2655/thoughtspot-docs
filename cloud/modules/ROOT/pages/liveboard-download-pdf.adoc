...
+
NOTE: If you choose not to truncate tables, the page number will appear only on the last page of the table. Note that page length of a non-truncated table will still count towards total page length of the pdf.
