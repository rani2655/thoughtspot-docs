...
== image:mysql-icon.png[Amazon Aurora MySQL icon] Amazon Aurora MySQL
...
== image:logo-postgresql.png[Amazon Aurora PostgreSQL icon] Amazon Aurora PostgreSQL
...
== image:mysql-icon.png[Amazon RDS MySQL icon] Amazon RDS MySQL
...
== image:logo-postgresql.png[Amazon RDS PostgreSQL icon] Amazon RDS PostgreSQL
