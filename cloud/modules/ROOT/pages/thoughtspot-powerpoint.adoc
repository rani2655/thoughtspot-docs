...
. Open PowerPoint. To download the plugin, Select *Home* > *Add-ins* > *Get Add-ins* > which brings up the PowerPoint Add-ins window, and search for ThoughtSpot, which will then show *ThoughtSpot for PowerPoint* in the list.
