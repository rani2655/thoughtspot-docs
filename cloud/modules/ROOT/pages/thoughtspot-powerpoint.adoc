...
:page-aliases:
:description: Learn about the ThoughtSpot add-on for Microsoft PowerPoint.
:jira: SCAL-224481, SCAL-245106
...
. Open PowerPoint. To download the plugin, Select *Insert* > *Add-ins* > *Get Add-ins* > which brings up the PowerPoint Add-ins window, and search for ThoughtSpot, which will then show *ThoughtSpot Analytics* in the list.
