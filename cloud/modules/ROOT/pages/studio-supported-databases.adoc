...
. Follow the steps to connect a database with xref:studio-connecting-analyst-studio-to-your-database.adoc#direct-connect[Direct Connect].
...
You can also xref:studio-connecting-analyst-studio-to-your-database.adoc#requirements[allowlist {product}'s servers] by editing the list of allowed IP addresses on mParticle UI, which will update the AWS security group settings associated with your Redshift cluster.
Once you have your credentials, follow the steps below to connect {product}:

. Log in to {product} and follow to steps to xref:studio-connecting-analyst-studio-to-your-database.adoc#direct-connect[connect a database to {product}].
...
. Follow these steps to xref:studio-connecting-analyst-studio-to-your-database.adoc[connect a Databricks database].
...
Start by xref:studio-connecting-analyst-studio-to-your-database.adoc[connecting a database.]
...
. You can utilize xref:studio-connecting-analyst-studio-to-your-database.adoc#bridge[Bridge connector] if you have a private IP address.
...
. Return to {product}, and begin the process to xref:studio-connecting-analyst-studio-to-your-database.adoc[connect a BigQuery database].
...
For databases that are not accessible, you can use the xref:studio-connecting-analyst-studio-to-your-database.adoc#bridge[Bridge connector].
...
. To connect to instances in a private VPC, you'll need to install our xref:studio-connecting-analyst-studio-to-your-database.adoc#bridge[Bridge connector].
