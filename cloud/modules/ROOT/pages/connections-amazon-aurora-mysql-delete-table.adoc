...
> **Related information**
>
> * xref:connections-amazon-aurora-mysql-add.adoc[Add a {connection} connection]
> * xref:connections-amazon-aurora-mysql-edit.adoc[Edit a {connection} connection]
> * xref:connections-amazon-aurora-mysql-remap.adoc[Remap a {connection} connection]
> * xref:connections-amazon-aurora-mysql-delete-table-dependencies.adoc[Delete a table with dependent objects]
> * xref:connections-amazon-aurora-mysql-delete.adoc[Delete a {connection} connection]
