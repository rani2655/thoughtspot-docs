...
You can teach Spotter how your organization uses your data by asking some questions, viewing the answers and help refine them by giving feedback. This will help Spotter to provide the kinds of answers you are looking for based on how your ask your questions. You can skip this step by clicking *Skip*. To coach Spotter later, go to *Manage data > Coach Spotter*, then click *Add coaching*.

To Coach Spotter, do the following:

. Select your data set if is not already selected.
...
. When you are happy with the answer, click *Next*.
+
[.bordered]
image::spotter-coach-3.png[]
. Review the search phrases you typed and their mapped search tokens.
