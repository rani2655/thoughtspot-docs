...
+
[.bordered]
image::connection-spotter-set-up-new-connection-2.png[]
...
You can optionally teach Spotter how your organization uses your data by asking some questions, viewing the answers and help refine them by giving feedback. This will help Spotter to provide the kinds of answers you are looking for based on how your ask your questions. You can skip this step, and coach Spotter later by going to *Manage data > Manage data sources* and clicking *Train Copilot*.
