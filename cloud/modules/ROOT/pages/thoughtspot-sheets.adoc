...
NOTE:
The *Refresh data* restores any data which was deleted from the sheet(s). To avoid this, it is recommended that you delete the sheet before refreshing data.