...
****
You can now add ad-hoc filters to the Liveboard underlying your KPI and set an alert that preserves those filters, all without saving the filter to the Liveboard. To enable this feature, contact your ThoughtSpot administrator. For more about Early Access features, see xref:release-lifecycle.adoc#early-access[ThoughtSpot Cloud release life cycle].
****
