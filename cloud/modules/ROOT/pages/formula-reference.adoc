...
NOTE: The following passthrough functions are supported by all cloud data warehouse types. Note that you cannot use passthrough functions in a query that involves a chasm trap.
