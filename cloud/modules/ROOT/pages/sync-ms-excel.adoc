...
. If this is the first sync you have created for Excel, a pop-up authorization window appears. To give ThoughtSpot permission to send data to your Microsoft Excel account, enter your sign-in credentials and select *Next*.
+
...
. By default, "Sync and save" is selected. Select *Save* to send your data to Excel. Your data immediately appears in the Sheet you specified.
