...
ifndef::spotter[]
IMPORTANT: Choosing to create a connection using either of these methods will not guide you through modeling your data, coaching {form-factor} or using {form-factor} to chat with your data, as described in xref:connections.adoc[Adding a data source in ThoughtSpot {form-factor}].
