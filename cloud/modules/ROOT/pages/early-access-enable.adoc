...
Allow users to switch to the new homepage and navigation from the user profile. For more information, see xref:user-profile#new-homepage-experience.adoc[Manage your navigation and homepage experience].
