...
Period-to-date keywords work slightly differently depending on whether you are using the DEFAULT calendar or a custom calendar and which cloud data warehouse you're using.
