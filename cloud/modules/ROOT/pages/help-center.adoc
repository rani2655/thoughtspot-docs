...
Contact support::
Get live and in-depth help from experts in the ThoughtSpot community and documentation.

Customizable help::
In addition to these features, your ThoughtSpot administrator can add custom links to the help menu, which appear directly below the *Contact support* menu item. For more information, see xref:customize-help.adoc[Customize ThoughtSpot Help].
