...
Models are a new, easier way of creating what previously were called Worksheets. You can create Models from the *Data* tab, just like Worksheets.

For this release, your ThoughtSpot administrator must enable Models. ThoughtSpot plans to replace Worksheets with Models in a future release, but for now you can create both Models and Worksheets.
...
Benefits of Model editor include:

- Building a schema by dragging and dropping tables and columns
- Creating joins between tables is easier
- Seeing the data model as you create it
- Using the tabbed interface allows you to switch between tables, columns, formulas, filters, parameters, and settings more intuitively
