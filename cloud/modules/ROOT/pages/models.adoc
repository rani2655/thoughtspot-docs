...
. If you don't want to add those now, click *Exit data model*.
...
+
If you want to change what your formula returns, click the Advanced settings button image:icon_formula_gear_32px.png[].
+
