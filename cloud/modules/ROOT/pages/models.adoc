...
:model: Model
:jira: SCAL-158357, SCAL-194041 (9.12.5 -drag to create joins), SCAL-194038 (9.12.5 - bulk edit column properties). SCAL-189664 (remove spotapps - removed from image in step 3 of creating a model.
