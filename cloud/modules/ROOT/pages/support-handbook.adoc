...
NOTE: The escalation option for P0 cases is available one day after the case is created. Escalation is available after 3 days for P1 cases, 5 days for P2 cases, and 7 days for P3 cases.
