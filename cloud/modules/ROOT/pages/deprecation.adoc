...
The 10.4.0.cl release of ThoughtSpot Cloud, targeted for November 2024 (GA), deprecates the following feature in the *Data workspace*. ThoughtSpot will remove this feature in a later release.

- *+ Create new* > *Worksheet*
+
Existing Worksheets continue to be available, but Worksheet creation is disabled by default. To enable Worksheet creation, you must contact your ThoughSpot administrator.
+
...
Bulk migration of Worksheets to Models will be available in the 10.5.0.cl release. Contact {support-url} for details.
