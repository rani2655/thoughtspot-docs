...
The 10.3.0.cl release of ThoughtSpot Cloud, targeted for October 2024 (GA), deprecates the following feature. You can still use this feature, but ThoughtSpot will remove these features in a later release.
