...
The 10.9.0.cl release of ThoughtSpot Cloud, targeted for Fall 2025, removes the following features:
...
The 10.8.0.cl release of ThoughtSpot Cloud, targeted for May 2025, deprecates the following features:
