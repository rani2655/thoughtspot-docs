...
+
All existing Worksheets will be migrated automatically to Models by this release and Worksheets will no longer be available.
...
+
ThoughtSpot recommends that you migrate your Worksheets to Models before the 10.12 release. For more information, see xref:worksheet-migration-single.adoc[Converting a single Worksheet to a Model].
