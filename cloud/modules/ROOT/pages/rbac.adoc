...
With the RBAC feature enabled on your instance, administrators can grant granular privileges to implement fine-grained access control to ThoughtSpot features, objects, and metadata.
...
|Allows administrators to manage Analyst Studio for ThoughtSpot users.
|===
