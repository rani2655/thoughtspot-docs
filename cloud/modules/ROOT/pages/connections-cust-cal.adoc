...
* Using date formulas with the `fiscal` option specified (See xref:{latest}@cloud:ROOT:formulas-date.adoc#fiscal-and-gregorian-calendars[Fiscal and Gregorian calendars])
...
> **Related information**
>
> * xref:{latest}@cloud:ROOT:connections-cust-cal-create.adoc[Create a custom calendar] +
> * xref:{latest}@cloud:ROOT:connections-cust-cal-update.adoc[Update a custom calendar] +
> * xref:{latest}@cloud:ROOT:connections-cust-cal-delete.adoc[Delete a custom calendar]
