...
. While viewing your Answer in either chart or table view, select the chart configuration icon image:icon-gear-10px.png[] at the upper right to open the _Edit_ pane.
