...
You can edit additional configurations after you create them. For details, see xref:connections-snowflake-edit.adoc#edit-additional-connections[Edit additional connections of your {connection} connection].
