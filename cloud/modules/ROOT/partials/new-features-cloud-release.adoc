...
Create an alert from the Watchlist on the home page [.badge.badge-early-access-whats-new]#Early Access#:: You can now create alerts directly from the *Watchlist* on the home page.
+
[.bordered]
