...
// Mary. JIRA: SCAL-228573
Org Switcher appearance::
If your company is not using Orgs, you will not see the Org switcher between the help icon and the *Search answers and Liveboards* search box.
