...
// Mark -- SCAL-179003
Custom charts [.badge.badge-early-access-relnotes]#Early Access#:: ThoughtSpot administrators can now add custom charts to a ThoughtSpot cluster.  For more information, see xref:chart-byoc.adoc[].
