...
// Mark -- SCAL-179003
Custom charts [.badge.badge-early-access-relnotes]#Early Access#:: You can now use custom charts created outside of ThoughtSpot. Developers with your company can create custom charts using the ThoughtSpot Charts SDK, and your administrator can add them to your cluster.  For more information, see xref:chart-byoc.adoc[].
