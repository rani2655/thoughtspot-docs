...
ifdef::pendo-links[]
xref:keywords-pt-BR.adoc[Português (Brasil) Keyword reference,window=_blank].
endif::[]
...
ifdef::pendo-links[]
xref:studio-get-started.adoc[Analyst Studio,window=_blank].
endif::[]
