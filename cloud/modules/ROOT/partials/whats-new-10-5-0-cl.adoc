...
ThoughtSpot users can now create, edit, and manage groups within Query Sets.
[.bordered]
...
// Mark. jira: SCAL-171985. docs jira: SCAL-234248
// PM: Arpit

Custom charts are now an Early Access feature. This feature allows you to use custom charts created outside of ThoughtSpot, including third-party chart libraries. To enable this feature, contact your administrator.
endif::free-trial-feature[]
...
// PM: Manan - waiting for details about how this differs from the advanced conditional formatting that was EA in 10.0.0.cl.
...
// PM: Himanshu - awaiting clarification about how this differs from the previous EA of per-org URLs that is set to GA in 10.6.0.cl.
