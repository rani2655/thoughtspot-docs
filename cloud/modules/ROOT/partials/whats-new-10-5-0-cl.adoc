...
Administrators can now add custom charts including ones created outside of ThoughtSpot. You can enable this feature by going to *Admin > All Orgs > Early access features*.
