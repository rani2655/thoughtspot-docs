...
<<cohort,cohort>>:
  ...
  <<answer,answer>>:
    ...
    <<table,table>>:
      ...
      - Number of Order ID
      <<client_state,client_state>>: ""
      <<client_state_v2,client_state_v2>>: "{\"tableVizPropVersion\": \"V1\",\"columnProperties\": [{\"columnId\": \"Customer Code\",\"columnProperty\": {}},{\"columnId\": \"Number of Order ID\",\"columnProperty\": {}}]}"
    <<display_mode,display_mode>>: TABLE_MODE
  <<config,config>>:
    <<cohort_type,cohort_type>>: ADVANCED
    <<anchor_column_id,anchor_column_id>>: Customer Code
