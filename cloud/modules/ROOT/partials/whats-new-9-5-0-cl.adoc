...
column descriptions, column verification status, table descriptions, and table verification status. This information appears when you click on the corresponding table or column under *Search data*. Once connected, metadata information is visible to all users.
