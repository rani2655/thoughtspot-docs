...
// Naomi-- move to other features and enhancements. title rename. add image of the knowledge card with info, red box around new metadata.
...
// Naomi-- change description of magic link-- custom url? custom link?
...
// Naomi-- move up to natural language search? check if it's the external-facing name
