...
ThoughtSpot introduces rol-based access control (RBAC) to allow for more granular level privileges. Use roles to apply privileges customized for your organizational needs.
