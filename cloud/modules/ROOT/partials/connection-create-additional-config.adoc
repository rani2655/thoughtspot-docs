...
****
Creating additional configurations for your {connection} connection is an Early Access feature and is disabled by default. To enable it, contact your ThoughtSpot administrator. For more about Early Access features, see xref:release.adoc#early-access[ThoughtSpot Cloud release life cycle].
****
