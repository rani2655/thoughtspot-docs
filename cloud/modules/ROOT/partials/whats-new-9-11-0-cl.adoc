...
You can now use custom charts created outside of ThoughtSpot. Developers in your company can create custom charts using the ThoughtSpot Charts SDK. To enable this feature, contact {support-url}.
For more information, see
ifndef::pendo-links[]
