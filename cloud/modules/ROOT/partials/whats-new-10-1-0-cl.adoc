...
You can now receive alerts when data of KPIs you are subscribed to fall outside the predicted value rage. To create an anomaly alert, navigate to the Liveboard containing your KPI, select the more options icon image:icon-more-10px.png[more options menu] on the KPI, click *Manage alerts*, and select *Anomaly*. You can choose at what time to check the KPI's data against the values predicted by ML models trained on the data. If the KPI value falls outside the predicted range, ThoughtSpot sends an alert to your email.
...
// Mary. JIRA: SCAL-181678. docs JIRA: SCAL-?
// PM: Manan
...
[#10-1-0-cl-cohorts]
[discrete]
=== Cohorts: TML CI/CD [.badge.badge-beta-whats-new]#Beta#
endif::[]
// Mary – Jira: SCAL-158900. docs JIRA: SCAL-?
// PM: Damian
...
[#10-1-0-cl-users]
[discrete]
=== Users and Groups v2 UI Phase 3
// Mary. JIRA: SCAL-198098. docs JIRA: SCAL-?
// PM: Aashica
...
// Mary. JIRA: SCAL-200386. docs JIRA: SCAL-?
// PM: Naman
