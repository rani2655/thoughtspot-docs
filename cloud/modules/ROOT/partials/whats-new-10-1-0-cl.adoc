...
You can choose at what time to check the KPI's data against the values predicted by ML models trained on the data. If the KPI value falls outside the predicted range, ThoughtSpot sends an alert to your email.
...
[#10-1-0-cl-coach]
[discrete]
=== Sage Coach improvements for 10.1
...
// Mary. JIRA: SCAL-181678. docs JIRA: SCAL-211771. get an instance and make a gif
// PM: Manan
endif::free-trial-feature[]
...
// PM: Damian - PRD is incomplete, need more info.
...
// PM: Aashica - Awaiting access to PRD and release status
...
// Mary. JIRA: SCAL-198098. docs JIRA: SCAL-?- awaiting confirmation if we should use SCAL-203421 that is currently in cancelled state. is this feature where you add a user's email and they receive an email to fill in their username/other info? magiclink?
// possible PRD: https://docs.google.com/document/d/1K2mxbo1HhtAJBqrzsNYQJcVzVy0kJd-7kNnEBw9vUXs/edit#heading=h.6meko28s0x63
// PM: Aashica
...
// PM: Aashica - awaiting confirmation, but suspect no doc needed. Same Org 1.5 PRD is linked.
