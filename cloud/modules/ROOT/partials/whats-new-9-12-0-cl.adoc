...
For more information, see
ifndef::pendo-links[]
xref:forecasting.adoc[Forecasting].
endif::[]
ifdef::pendo-links[]
xref:forecasting.adoc[Forecasting,window=_blank].
endif::[]
...
// Mary – SCAL-156211
//Need clarification from PM. The same PRD as was linked for all other Org related features since 9.8.0.cl with no updates. Need clarification about what this update is for 9.12.0.cl. Confirmed no doc needed for 9.12.0.cl as this will not be avaialble to customers in until 10.1.0.cl with SCAL-203123.
// PM: Vijay/Aashica
