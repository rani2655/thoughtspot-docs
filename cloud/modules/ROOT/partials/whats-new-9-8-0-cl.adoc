...
Change analysis _more insights_ are now available and enabled by default. For example, ThoughtSpot finds values that underwent the highest percentage change between the two data points defined in your analysis, and values whose share of the total changed the most. The insights appear below the main analysis in the change analysis pop-up window.
...
The following connections are now available to all customers and on by default:
...
// Naomi -- SCAL-161589. release notes only?
