...
[#9-8-0-cl-atlan]
[discrete]
=== GA - ThoughtSpot Connector to Atlan
...
[#9-8-0-cl-alloydb]
[discrete]
=== Google AlloyDB for PostgreSQL connection

// Naomi -- SCAL-166161

[#9-8-0-cl-cloud-sql]
[discrete]
=== Google Cloud SQL for SQL Server connection

// Naomi -- SCAL-166160

[#9-8-0-cl-postgresql]
[discrete]
=== Google Cloud SQL for PostgreSQL connection
...
[#9-8-0-cl-singlestore]
[discrete]
=== [GA] SingleStore connection
