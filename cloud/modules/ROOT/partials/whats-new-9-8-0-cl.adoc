...
When you delete a visualization, ThoughtSpot now removes the object from your object count in the Object Usage Liveboard. This ensures a more accurate count of objects in use.
