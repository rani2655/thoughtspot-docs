...
IMPORTANT: To ensure best performance, we recommended that you not have more than 40 visualizations within a tab. Having more than 40 visualizations decreases the performance of the Liveboards and may also cause PDF exports and schedules to fail.
